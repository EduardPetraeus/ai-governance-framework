...
- IDE governance file for your primary editor (see [docs/multi-ide-support.md](multi-ide-support.md))
...
- Automated test suite covering governance scripts (see [`automation/`](../automation/))
- Cost tracking automation via `automation/token_counter.py` and `automation/cost_dashboard.py`
...
1. Generate a governance dashboard with `automation/governance_dashboard.py` — this is the primary Level 4 artifact
...
6. Run `automation/cost_dashboard.py` monthly and act on routing recommendations
...
- `DASHBOARD.md` generated weekly by `automation/governance_dashboard.py` — the primary observability artifact
- `COST_DASHBOARD.md` generated monthly by `automation/cost_dashboard.py` — model routing efficiency tracking
...
- Test coverage >70%
- Cost optimization: actual vs. optimal routing cost, monthly review via cost dashboard
...
```
project-root/
├── DASHBOARD.md                   # Generated by automation/governance_dashboard.py
├── COST_DASHBOARD.md              # Generated by automation/cost_dashboard.py
├── docs/
...
**Governance dashboard**: run `automation/governance_dashboard.py` weekly to generate `DASHBOARD.md`. The dashboard consolidates health score, session velocity, cost trends, knowledge health, ADR coverage, sprint progress, and maturity level into a single Markdown file. No external dependencies. See [docs/metrics-guide.md](metrics-guide.md) for the full metric reference.

**Cost dashboard**: run `automation/cost_dashboard.py` monthly to generate `COST_DASHBOARD.md`. Breaks down spend by model, session type, and time period. Calculates routing efficiency ratio (actual cost / optimal cost) and recommends model switches where savings are available.
